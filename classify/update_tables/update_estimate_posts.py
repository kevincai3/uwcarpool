...
from utils.helper import format_all_time, format_all_date, generateUpsertSQL
...
def update_estimate_posts(new_derived_posts):
    ...
    values = [(post_id, post_type, best_date, format_all_date(all_dates), best_time, format_all_time(all_times), from_locs, to_locs)
